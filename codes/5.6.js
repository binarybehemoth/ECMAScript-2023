...
Promise.race([a, b]).then(
    value => console.log(`race: fulfilled with ${value}`),
    reason => console.log(`race: rejected with {reason.message}`)
);

Promise.any([a, b]).then(
    value => console.log(`any:  fulfilled with ${value}`),
reason => console.log(`any:  rejected with 
